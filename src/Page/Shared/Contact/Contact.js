    ...
    return (
        <div style={{
            ...
            <form className='grid grid-cols-1 gap-4 justify-items-center'>
                ...
                <input type="textarea" placeholder="Your Massage" className="input input-bordered w-full max-w-xs" />
                <input type="submit" value='submit' className="input input-bordered text-white bg-gradient-to-r from-secondary to-primary font-bold max-w-xs" />
            </form>
        </div>
    );
};
